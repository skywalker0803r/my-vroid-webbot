...
var refColor = (0, import_tsl.materialReference)("color", "color");
var refMap = (0, import_tsl.materialReference)("map", "texture");
var refNormalMap = (0, import_tsl.materialReference)("normalMap", "texture");
var refNormalScale = (0, import_tsl.materialReference)("normalScale", "vec2");
var refEmissive = (0, import_tsl.materialReference)("emissive", "color");
var refEmissiveIntensity = (0, import_tsl.materialReference)("emissiveIntensity", "float");
var refEmissiveMap = (0, import_tsl.materialReference)("emissiveMap", "texture");
var refShadeColorFactor = (0, import_tsl.materialReference)("shadeColorFactor", "color");
var refShadingShiftFactor = (0, import_tsl.materialReference)("shadingShiftFactor", "float");
var refShadeMultiplyTexture = (0, import_tsl.materialReference)("shadeMultiplyTexture", "texture");
var refShadeMultiplyTextureScale = (0, import_tsl.materialReference)("shadeMultiplyTextureScale", "float");
var refShadingToonyFactor = (0, import_tsl.materialReference)("shadingToonyFactor", "float");
var refRimLightingMixFactor = (0, import_tsl.materialReference)("rimLightingMixFactor", "float");
var refRimMultiplyTexture = (0, import_tsl.materialReference)("rimMultiplyTexture", "texture");
var refMatcapFactor = (0, import_tsl.materialReference)("matcapFactor", "color");
var refMatcapTexture = (0, import_tsl.materialReference)("matcapTexture", "texture");
var refParametricRimColorFactor = (0, import_tsl.materialReference)("parametricRimColorFactor", "color");
var refParametricRimLiftFactor = (0, import_tsl.materialReference)("parametricRimLiftFactor", "float");
var refParametricRimFresnelPowerFactor = (0, import_tsl.materialReference)("parametricRimFresnelPowerFactor", "float");
var refOutlineWidthMultiplyTexture = (0, import_tsl.materialReference)("outlineWidthMultiplyTexture", "texture");
var refOutlineWidthFactor = (0, import_tsl.materialReference)("outlineWidthFactor", "float");
var refOutlineColorFactor = (0, import_tsl.materialReference)("outlineColorFactor", "color");
var refOutlineLightingMixFactor = (0, import_tsl.materialReference)("outlineLightingMixFactor", "float");
var refUVAnimationMaskTexture = (0, import_tsl.materialReference)("uvAnimationMaskTexture", "texture");
var refUVAnimationScrollXOffset = (0, import_tsl.materialReference)("uvAnimationScrollXOffset", "float");
var refUVAnimationScrollYOffset = (0, import_tsl.materialReference)("uvAnimationScrollYOffset", "float");
var refUVAnimationRotationPhase = (0, import_tsl.materialReference)("uvAnimationRotationPhase", "float");
...
var MToonAnimatedUVNode = class extends THREE2.TempNode {
  ...
  setup() {
    ...
    if (this.hasMaskTexture) {
      uvAnimationMask = (0, import_tsl2.vec4)(refUVAnimationMaskTexture).context({ getUV: () => (0, import_tsl2.uv)() }).r;
    }
    let animatedUv = (0, import_tsl2.uv)();
    const phase = refUVAnimationRotationPhase.mul(uvAnimationMask);
    const c = (0, import_tsl2.cos)(phase);
    const s = (0, import_tsl2.sin)(phase);
    animatedUv = animatedUv.sub((0, import_tsl2.vec2)(0.5, 0.5));
    animatedUv = animatedUv.mul((0, import_tsl2.mat2)(c, s, s.negate(), c));
    animatedUv = animatedUv.add((0, import_tsl2.vec2)(0.5, 0.5));
    const scroll = (0, import_tsl2.vec2)(refUVAnimationScrollXOffset, refUVAnimationScrollYOffset).mul(uvAnimationMask);
...
var shadeColor = (0, import_tsl3.nodeImmutable)(THREE3.PropertyNode, "vec3").toVar("ShadeColor");
var shadingShift = (0, import_tsl3.nodeImmutable)(THREE3.PropertyNode, "float").toVar("ShadingShift");
var shadingToony = (0, import_tsl3.nodeImmutable)(THREE3.PropertyNode, "float").toVar("ShadingToony");
var rimLightingMix = (0, import_tsl3.nodeImmutable)(THREE3.PropertyNode, "float").toVar("RimLightingMix");
var rimMultiply = (0, import_tsl3.nodeImmutable)(THREE3.PropertyNode, "vec3").toVar("RimMultiply");
var matcap = (0, import_tsl3.nodeImmutable)(THREE3.PropertyNode, "vec3").toVar("matcap");
var parametricRim = (0, import_tsl3.nodeImmutable)(THREE3.PropertyNode, "vec3").toVar("ParametricRim");
...
var getShading = FnCompat(({ dotNL }) => {
  const shadow = 1;
  const feather = (0, import_tsl4.float)(1).sub(shadingToony);
...
var getDiffuse = FnCompat(
  ({ shading, lightColor }) => {
    const feathered = (0, import_tsl4.mix)(shadeColor, import_tsl4.diffuseColor, shading);
    const col = lightColor.mul((0, import_tsl4.BRDF_Lambert)({ diffuseColor: feathered }));
    return col;
  }
);
var MToonLightingModel = class extends THREE4.LightingModel {
  ...
  direct({
    ...
    const dotNL = import_tsl4.transformedNormalView.dot(lightDirection).clamp(-1, 1);
    ...
    reflectedLight.directSpecular.addAssign(
      parametricRim.add(matcap).mul(rimMultiply).mul((0, import_tsl4.mix)((0, import_tsl4.vec3)(0), (0, import_tsl4.BRDF_Lambert)({ diffuseColor: lightColor }), rimLightingMix))
    );
  }
  // COMPAT: pre-r174
  ...
  indirectDiffuse(context) {
    ...
    reflectedLight.indirectDiffuse.addAssign(
      irradiance.mul((0, import_tsl4.BRDF_Lambert)({ diffuseColor: import_tsl4.diffuseColor }))
    );
  }
  indirectSpecular(context) {
    const { reflectedLight } = context;
    reflectedLight.indirectSpecular.addAssign(
      parametricRim.add(matcap).mul(rimMultiply).mul((0, import_tsl4.mix)((0, import_tsl4.vec3)(1), (0, import_tsl4.vec3)(0), rimLightingMix))
    );
  }
};
...
var mtoonParametricRim = FnCompat(
  ({
    ...
    const viewDir = import_tsl5.modelViewPosition.normalize();
    const dotNV = import_tsl5.transformedNormalView.dot(viewDir.negate());
    const rim = (0, import_tsl5.float)(1).sub(dotNV).add(parametricRimLift).clamp().pow(parametricRimFresnelPower);
...
var MToonNodeMaterial = class extends THREE5.NodeMaterial {
  ...
  setupDiffuseColor(builder) {
    ...
    if (parseInt(THREE5.REVISION, 10) < 166) {
      if (this.transparent === false && this.blending === THREE5.NormalBlending && this.alphaToCoverage === false) {
        import_tsl6.diffuseColor.a.assign(1);
      }
    }
  ...
  setupOutput(builder, outputNode) {
    if (this.isOutline && this.outlineWidthMode !== MToonMaterialOutlineWidthMode.None) {
      outputNode = (0, import_tsl6.vec4)(
        (0, import_tsl6.mix)(refOutlineColorFactor, outputNode.xyz.mul(refOutlineColorFactor), refOutlineLightingMixFactor),
        outputNode.w
      );
    }
  ...
  setupPosition(builder) {
    ...
    if (this.isOutline && this.outlineWidthMode !== MToonMaterialOutlineWidthMode.None) {
      (_a = this.positionNode) != null ? _a : this.positionNode = import_tsl6.positionLocal;
      const normalLocalNormalized = import_tsl6.normalLocal.normalize();
      ...
      const worldNormalLength = (0, import_tsl6.length)(import_tsl6.modelNormalMatrix.mul(normalLocalNormalized));
      ...
      if (this.outlineWidthMode === MToonMaterialOutlineWidthMode.WorldCoordinates) {
        ...
        const clipScale = import_tsl6.cameraProjectionMatrix.element(1).element(1);
        const tempPositionView = import_tsl6.modelViewMatrix.mul(import_tsl6.positionLocal);
        this.positionNode = this.positionNode.add(
          outlineOffset.div(clipScale).mul(tempPositionView.z.negate())
        );
      }
      (_b = this.positionNode) != null ? _b : this.positionNode = import_tsl6.positionLocal;
    }
  ...
  _setupShadeColorNode() {
    if (this.shadeColorNode != null) {
      return (0, import_tsl6.vec3)(this.shadeColorNode);
    }
  ...
  _setupShadingShiftNode() {
    if (this.shadingShiftNode != null) {
      return (0, import_tsl6.float)(this.shadingShiftNode);
    }
  ...
  _setupRimMultiplyNode() {
    ...
    return (0, import_tsl6.vec3)(1);
  }
  _setupMatcapNode() {
    if (this.matcapNode != null) {
      return (0, import_tsl6.vec3)(this.matcapNode);
    }
    if (this.matcapTexture && this.matcapTexture.isTexture === true) {
      const map = refMatcapTexture.context({ getUV: () => import_tsl6.matcapUV.mul(1, -1).add(0, 1) });
      return map.mul(refMatcapFactor);
    }
    return (0, import_tsl6.vec3)(0);
  }
  _setupParametricRimNode() {
    const parametricRimColor = this.parametricRimColorNode != null ? (0, import_tsl6.vec3)(this.parametricRimColorNode) : refParametricRimColorFactor;
    const parametricRimLift = this.parametricRimLiftNode != null ? (0, import_tsl6.float)(this.parametricRimLiftNode) : refParametricRimLiftFactor;
    const parametricRimFresnelPower = this.parametricRimFresnelPowerNode != null ? (0, import_tsl6.float)(this.parametricRimFresnelPowerNode) : refParametricRimFresnelPowerFactor;
